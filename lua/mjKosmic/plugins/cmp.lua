...
dependencies = {
    ...
    'hrsh7th/cmp-nvim-lsp', -- Source for completions in LSP
    'hrsh7th/cmp-path',	    -- Source for completions in file system paths
    'hrsh7th/cmp-buffer',   -- Source for completions in the buffer
},
config = function()
    -- See `:help cmp`
